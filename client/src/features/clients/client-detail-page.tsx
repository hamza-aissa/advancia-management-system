...
export function ClientDetailPage() {
  ...
  return <div className="space-y-6">
    ...
    <Dialog open={editOpen} onOpenChange={setEditOpen} title={isAdmin ? 'Modifier le client' : 'Mettre à jour le contexte'} description={isAdmin ? 'Modifiez les coordonnées, les affectations et le contexte.' : 'Renseignez le dernier contact et les notes de ce compte.'}>
